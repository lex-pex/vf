...
class HomeController extends Controller
{
    ...
    private function getShopHeaders() {
        return [
            ...
            'description' => 'Акция "Еда Без Вреда", благотворительная акция, не прибыльный проэкт по распространению идеи этичности и здоровья. Это версия волонтёрского магазина для развития веганства и распространения культуры полезного питания',
