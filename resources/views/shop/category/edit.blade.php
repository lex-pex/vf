...
<div class="row justify-content-center pad-top-50">
    <div class="col-lg-8 col-md-10 col-sm-12">
        ...
        @endif
            <div class="row">
                <div class="col-6">
                    <a href="/admin/shop/categories"><i class="fa fa-backward"></i> Назад Категории</a>
                </div>
        ...
        <div class="row">
            <div class="col-12">
                <hr/>
                <form action="{{ route('categoryUpdate', ['category' => $category]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <img src="{{ $category->image ? $category->image : '/img/shop/details/no_photo.jpg' }}" style="width:100%" />
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="sort" class="form-control" type="text" name="sort" value="{{ $category->sort }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="descr" name="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" rows="3" placeholder="Описание категории... (до 255 символов)" style="resize:none;">{!! $category->description !!}</textarea>
                    </div>
                    <div class="row">
                        <div class="col-6">
                ...
                <form id="rub_del_form" action="{{ route('categoryDelete', ['category' => $category->id]) }}" method="post">
                    {{ method_field('DELETE') }}
                    {{ csrf_field() }}
                </form>
