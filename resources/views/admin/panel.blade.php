...
<div class="row justify-content-center pad-top-50">
    <div class="col-lg-8 col-md-10 col-sm-12">
        ...
        <div class="bg-light row text-center border-top border-bottom mt-3 pt-3 pb-3">
            <div class="col-6">
                iHerb 1: <span class="cyphers" id="iherb_counter_1">{{ ($v = Visit::where('page', 'iHerb_1')->first()) ? $v->amount : 0 }}</span>
                <button class="float-right btn btn-sm btn-outline-dark" onclick="event.preventDefault();ihCountReset(1)">Reset</button>
            </div>
            <div class="col-6">
                iHerb 2: <span class="cyphers" id="iherb_counter_2">{{ ($v = Visit::where('page', 'iHerb_2')->first()) ? $v->amount : 0 }}</span>
                <button class="float-right btn btn-sm btn-outline-dark" onclick="event.preventDefault();ihCountReset(2)">Reset</button>
            </div>
        </div>
